        ...
        <Card className="p-5 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-medium">Campus Address</div>
                <div className="text-sm text-muted-foreground">Kongunadu Arts and Science College,<br/>GN Mills Post, Coimbatore - 641 029</div>
              </div>
            </div>
          </div>
        </Card>
